...
python3 /opt/xyz/sources/set_hostname.py "${base_hostname}" "${domain}" 
...
curl -O https://artifacts.xyz.intranet/artifactory/test-canary-local/terraform-svn/1.0.0-SNAPSHOT/terraform-svn-1.0.0-SNAPSHOT.zip
